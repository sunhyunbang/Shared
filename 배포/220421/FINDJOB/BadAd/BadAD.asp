		...
		<div id="FRWrap">
			...
			<div class="body">
				...
				<div style="margin-top:10px;padding:10px;border:1px solid #d7d7d7;background-color:#f8f8f8;">
					<p style="font-size:11px;line-height:18px;color:#777"><strong style="font-size:12px;color:#777">개인정보 수집 및 이용 안내 (필수)</strong><br />1. 수집 항목 : 이메일, 휴대폰 번호<br />2. 수집·이용목적 : 민원 처리 및 결과 회신<br />3. 보유 및 이용기간 : <strong>신고 접수일로부터 3년</strong></p>
