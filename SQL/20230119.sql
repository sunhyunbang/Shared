...
/*
SELECT * 
INTO PP_AD_TB_20230206
FROM PP_AD_TB WHERE  LINEADNO IN(
SELECT LINEADNO FROM #TMP_TB
)
*/

--SELECT LINEADNO , END_DT , ENDYN ,MOD_DT FROM PP_AD_TB_20230206
...
UPDATE PP_AD_TB_20230206  
SET ENDYN = 'Y'  
    ,END_DT = GETDATE()  
    ,MOD_DT = GETDATE()  
WHERE LINEADNO = @LINEADNO

EXECUTE p_SyncIssueData @LINEADID, @INPUT_BRANCH, @LAYOUT_BRANCH,  'L', 'E'  
